...
export default function ContactsPage() {
  ...
  async function save() {
    ...
    try {
      ...
      await logAction(currentUser, "Added Contact", { contactName: form.name, company: form.company });
  ...
  async function handleRemoveSP(sp) {
    if (!confirm(`Remove "${sp.name}" from salespersons? This won't affect existing contacts.`)) return;
    try {
      const { deleteDoc: del, doc: d, db: database } = await import("../lib/firebase");
      await del(d(database, "salespersons", sp.id));
    ...
    <div className="p-6">
      ...
      <div className="flex items-center justify-between mb-4 flex-wrap gap-2">
        ...
        <div className="flex gap-2 flex-wrap">
          ...
          <button
            ...
            title="Add or remove salespersons"
          >
      ...
      <div className="flex gap-3 mb-4 flex-wrap">
        <input
          ...
          placeholder="Search by name, company, city, phone, salesperson..."
          value={search}
          ...
          <div className="space-y-4 max-h-[72vh] overflow-y-auto pr-1">
            ...
            <div className="border-t border-gray-100 pt-3">
              <div className="flex items-center justify-between mb-1">
                ...
                <button onClick={() => setShowSPModal(true)} className="text-xs text-blue-600 hover:underline">
                  + Manage salespersons
                </button>
              </div>
          ...
          <div className="space-y-4">
            ...
            <div>
              ...
              <div className="flex gap-2">
                <input
                  ...
                  onKeyDown={(e) => e.key === "Enter" && handleAddSP()}
                />
            ...
            <div>
              <label className="block text-xs font-medium text-gray-600 mb-2">
                Current salespersons ({salespersons.length})
              </label>
            ...
            <p className="text-xs text-gray-400 bg-amber-50 border border-amber-100 rounded-lg p-3">
              ℹ️ Removing a salesperson won't affect contacts already assigned to them. Only removes from the dropdown list.
            </p>
