        ...
        <div className="p-4 border-b border-gray-100">
          <div className="flex items-center gap-2">
            ...
            <div>
              ...
              <p className="text-xs text-gray-400">{isAdmin ? "Admin" : userData?.salesperson || "CRM"}</p>
            </div>
          </div>
        </div>
        ...
        <div className="p-3 border-t border-gray-100">
          <div className="flex items-center gap-2 px-2 py-1.5">
            {photoURL
              ...
              : <div className="w-7 h-7 rounded-full bg-blue-100 flex items-center justify-center text-xs font-semibold text-blue-700">{initial}</div>
            }
            <div className="flex-1 min-w-0">
              <p className="text-xs font-medium text-gray-900 truncate">{displayName}</p>
              <p className="text-xs text-gray-400 truncate">{email}</p>
            </div>
            <NotificationBell currentUser={userData} onClick={() => onNav("notifications")} />
